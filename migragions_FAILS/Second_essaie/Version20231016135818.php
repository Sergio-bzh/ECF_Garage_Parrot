...
namespace DoctrineMigrations\FAILS\Second_essaie;
 ...
 */
final class Version20231016135818 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE vehicle (id INT AUTO_INCREMENT NOT NULL, garage_id INT DEFAULT NULL, kilometers INT NOT NULL, price NUMERIC(10, 2) NOT NULL, desription LONGTEXT NOT NULL, registration_date DATE NOT NULL, INDEX IDX_1B80E486C4FFF555 (garage_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
